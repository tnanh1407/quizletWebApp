...
import Classes from "./pageCreators/Classes";
import Subjects from "./pageCreators/Subjects";
import Tests from "./pageCreators/Tests";
import Folder from "./pageCreators/Folder";
      ...
      <div className="creator-content">
        <div className="creator-header">
          <img
            ...
            src={creator?.avatar || "https://i.imgur.com/your-default-avatar.png"}
            alt="Creator avatar"
          />
          <div className="creator-info">
            <div className="creator-name-row">
              <span className="creator-name">{creator?.name || "Tên người dùng"}</span>
              {creator?.role && (
        ...
        <div className="creator-tabs">
          <span
            className={`creator-tab${activeTab === "subjects" ? " active" : ""}`}
