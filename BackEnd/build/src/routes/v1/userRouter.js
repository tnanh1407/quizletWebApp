...
import { verifyToken, isAdmin, isSelfOrAdmin } from "../../middlewares/authMiddleware.js";
...
router.patch("/:id/password", verifyToken, isSelfOrAdmin, userController.changePassword);
