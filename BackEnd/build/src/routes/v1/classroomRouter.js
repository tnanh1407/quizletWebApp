...
router.delete("/:classroomId/flashcards/:flashcardId", classroomController.removeFlashcard);
router.patch("/:id/folders", classroomController.addFolders);
router.delete("/:classroomId/folders/:folderId", classroomController.removeFlashcard);
router.patch("/:id/members", classroomController.addMember); // body: { user_id, username, role }
router.delete("/:classroomId/members/:userId", classroomController.removeMember);
