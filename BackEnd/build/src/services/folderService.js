...
const addFlashcards = async (folderId, flashcardIds) => folderModel.addFlashcards(folderId, flashcardIds);
const removeFlashcard = async (folderId, flashcardId) => folderModel.removeFlashcard(folderId, flashcardId);
